...
export default function Transaction() {
    ...
    return (
        <div>
            ...
            <div className="m-4">
                <h3 style={{textAlign:"center"}}>Easy Way to Pay Just Enter the Receiver UPI Id</h3>
                <br></br>
                ...
                <br></br>
                <br></br>
                <Button onClick={handleTransaction} variant="contained" endIcon={<SendIcon />}>Send Money</Button>
                {message && <p>{message}</p>}
            </div>
            <div className="m-4">
